...
#ifndef VSLAM_FEATURE_ORB_EXTRACTOR_H
#define VSLAM_FEATURE_ORB_EXTRACTOR_H

#include "vslam/feature/orb_params.h"
#include "vslam/feature/orb_extractor_node.h"
...
namespace vslam {
    namespace feature {
        ...
        private:
            ...
            distribute_keypoints_via_tree(const std::vector<cv::KeyPoint> &keypts_to_distribute,
            ...
            void assign_child_nodes(const std::array<orb_extractor_node, 4> &child_nodes,
...
#endif //VSLAM_FEATURE_ORB_EXTRACTOR_H
