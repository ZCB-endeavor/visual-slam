...
#ifndef VSLAM_MATCH_BOW_TREE_H
#define VSLAM_MATCH_BOW_TREE_H
...
namespace vslam {
    ...
    namespace match {
        ...
        public:
            ...
            unsigned int match_frame_and_keyframe(data::keyframe *keyfrm, data::frame &frm,
            ...
            unsigned int match_keyframes(data::keyframe *keyfrm_1, data::keyframe *keyfrm_2,
                                         std::vector<data::landmark *> &matched_lms_in_keyfrm_1) const;
        };
    }
}

#endif //VSLAM_MATCH_BOW_TREE_H
