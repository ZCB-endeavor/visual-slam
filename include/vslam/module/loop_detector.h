...
#ifndef VSLAM_MODULE_LOOP_DETECTOR_H
#define VSLAM_MODULE_LOOP_DETECTOR_H

#include "vslam/data/bow_vocabulary.h"
#include "vslam/module/type.h"
#include "vslam/optimize/transform_optimizer.h"
...
namespace vslam {
    ...
    namespace module {
        ...
        public:
             ...
             * Constructor
             */
            loop_detector(data::bow_database *bow_db, data::bow_vocabulary *bow_vocab, const YAML::Node &yaml_node,
...
#endif //VSLAM_MODULE_LOOP_DETECTOR_H
