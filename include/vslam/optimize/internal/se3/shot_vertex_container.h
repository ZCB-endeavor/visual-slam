...
#ifndef VSLAM_OPTIMIZE_INTERNAL_SE3_SHOT_VERTEX_CONTAINER_H
#define VSLAM_OPTIMIZE_INTERNAL_SE3_SHOT_VERTEX_CONTAINER_H

#include "vslam/type.h"
#include "vslam/data/frame.h"
#include "vslam/data/keyframe.h"
#include "vslam/optimize/internal/se3/shot_vertex.h"
        ...
        namespace internal {
            namespace se3 {
                ...
                public:
                    ...
                    shot_vertex *
                    create_vertex(const unsigned int id, const Mat44_t &cam_pose_cw, const bool is_constant);
                ...
                inline shot_vertex_container::shot_vertex_container(const std::shared_ptr<unsigned int> offset,
                ...
                inline shot_vertex *
                shot_vertex_container::create_vertex(data::keyframe *keyfrm, const bool is_constant) {
                    return create_vertex(keyfrm->id_, keyfrm->get_cam_pose(), is_constant);
                }

                inline shot_vertex *
                shot_vertex_container::create_vertex(const unsigned int id, const Mat44_t &cam_pose_cw,
...
#endif //VSLAM_OPTIMIZE_INTERNAL_SE3_SHOT_VERTEX_CONTAINER_H
