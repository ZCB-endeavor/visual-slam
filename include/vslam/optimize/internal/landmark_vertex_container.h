...
#ifndef VSLAM_OPTIMIZE_INTERNAL_LANDMARK_VERTEX_CONTAINER_H
#define VSLAM_OPTIMIZE_INTERNAL_LANDMARK_VERTEX_CONTAINER_H

#include "vslam/type.h"
#include "vslam/data/landmark.h"
#include "vslam/optimize/internal/landmark_vertex.h"
...
namespace vslam {
    ...
    namespace optimize {
        namespace internal {
            ...
            inline landmark_vertex_container::landmark_vertex_container(const std::shared_ptr<unsigned int> offset,
            ...
            inline landmark_vertex *
            landmark_vertex_container::create_vertex(data::landmark *lm, const bool is_constant) {
                return create_vertex(lm->id_, lm->get_pos_in_world(), is_constant);
            }

            inline landmark_vertex *landmark_vertex_container::create_vertex(const unsigned int id, const Vec3_t &pos_w,
...
#endif //VSLAM_OPTIMIZE_INTERNAL_LANDMARK_VERTEX_CONTAINER_H
