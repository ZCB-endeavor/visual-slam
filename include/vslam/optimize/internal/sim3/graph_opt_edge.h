...
#ifndef VSLAM_OPTIMIZE_INTERNAL_SIM3_GRAPH_OPT_EDGE_H
#define VSLAM_OPTIMIZE_INTERNAL_SIM3_GRAPH_OPT_EDGE_H

#include "vslam/type.h"
#include "vslam/optimize/internal/sim3/shot_vertex.h"
    ...
    namespace optimize {
        namespace internal {
            namespace sim3 {
                ...
                inline double graph_opt_edge::initialEstimatePossible(const g2o::OptimizableGraph::VertexSet &,
                                                                      g2o::OptimizableGraph::Vertex *) {
                    return 1.0;
                }

                inline void graph_opt_edge::initialEstimate(const g2o::OptimizableGraph::VertexSet &from,
                                                            g2o::OptimizableGraph::Vertex *) {
...
#endif //VSLAM_OPTIMIZE_INTERNAL_SIM3_GRAPH_OPT_EDGE_H
