...
#ifndef VSLAM_SOLVE_FUNDAMENTAL_SOLVER_H
#define VSLAM_SOLVE_FUNDAMENTAL_SOLVER_H
...
namespace vslam {
    namespace solve {
        ...
        public:
            ...
            static Mat33_t
            compute_F_21(const std::vector<cv::Point2f> &keypts_1, const std::vector<cv::Point2f> &keypts_2);
...
#endif //VSLAM_SOLVE_FUNDAMENTAL_SOLVER_H
