...
#ifndef VSLAM_SOLVE_SIM3_SOLVER_H
#define VSLAM_SOLVE_SIM3_SOLVER_H
...
namespace vslam {
    namespace solve {
        ...
        protected:
            ...
            void
            reproject_to_other_image(const std::vector<Vec3_t, Eigen::aligned_allocator<Vec3_t>> &lm_coords_in_cam_1,
...
#endif //VSLAM_SOLVE_SIM3_SOLVER_H
