...
#ifndef VSLAM_CAMERA_PERSPECTIVE_H
#define VSLAM_CAMERA_PERSPECTIVE_H
...
namespace vslam {
    namespace camera {
        ...
        public:
            ...
            void undistort_keypoints(const std::vector<cv::KeyPoint> &dist_keypts,
            ...
            void convert_bearings_to_keypoints(const eigen_alloc_vector<Vec3_t> &bearings,
                                               std::vector<cv::KeyPoint> &undist_keypts) const override final;

            bool reproject_to_image(const Mat33_t &rot_cw, const Vec3_t &trans_cw, const Vec3_t &pos_w, Vec2_t &reproj,
...
#endif //VSLAM_CAMERA_PERSPECTIVE_H
