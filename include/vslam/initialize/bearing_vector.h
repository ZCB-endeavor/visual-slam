...
#ifndef VSLAM_INITIALIZE_BEARING_VECTOR_H
#define VSLAM_INITIALIZE_BEARING_VECTOR_H

#include "vslam/type.h"
#include "vslam/initialize/base.h"
...
#endif //VSLAM_INITIALIZE_BEARING_VECTOR_H
