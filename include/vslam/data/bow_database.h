...
#ifndef VSLAM_DATA_BOW_DATABASE_H
#define VSLAM_DATA_BOW_DATABASE_H
...
namespace vslam {
    namespace data {
        ...
        protected:
            ...
            template<typename T>
            bool
            set_candidates_sharing_words(const T *const qry_shot, const std::set<keyframe *> &keyfrms_to_reject = {});
...
#endif //VSLAM_DATA_BOW_DATABASE_H
