...
#ifndef VSLAM_DATA_FRAME_H
#define VSLAM_DATA_FRAME_H
...
namespace vslam {
    ...
    namespace data {
        ...
        public:
             ...
             * @param mask
             */
            frame(const std::string image_name, const cv::Mat &img_gray, const double timestamp,
            ...
            get_keypoints_in_cell(const float ref_x, const float ref_y, const float margin, const int min_level = -1,
