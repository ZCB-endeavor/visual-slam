...
#ifndef VSLAM_DATA_KEYFRAME_H
#define VSLAM_DATA_KEYFRAME_H
...
namespace vslam {
    ...
    namespace data {
        ...
        public:
            ...
            get_keypoints_in_cell(const float ref_x, const float ref_y, const float margin) const;
