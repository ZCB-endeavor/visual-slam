...
#ifndef VSLAM_DATA_COMMON_H
#define VSLAM_DATA_COMMON_H
...
namespace vslam {
    namespace data {
        ...
        std::vector<cv::KeyPoint> convert_json_to_undistorted(const nlohmann::json &json_undist_keypts,
 ...
 */
        inline bool
        get_cell_indices(camera::base *camera, const cv::KeyPoint &keypt, int &cell_idx_x, int &cell_idx_y) {
