...
#ifndef VSLAM_GLOBAL_OPTIMIZATION_MODULE_H
#define VSLAM_GLOBAL_OPTIMIZATION_MODULE_H

#include "vslam/type.h"
#include "vslam/data/bow_vocabulary.h"
#include "vslam/module/type.h"
#include "vslam/module/loop_detector.h"
#include "vslam/module/loop_bundle_adjuster.h"
#include "vslam/optimize/graph_optimizer.h"
...
namespace vslam {
    ...
    public:
        ...
        global_optimization_module(data::map_database *map_db, data::bow_database *bow_db,
                                   data::bow_vocabulary *bow_vocab, const YAML::Node &yaml_node, const bool fix_scale);
    ...
    private:
        ...
        get_Sim3s_before_loop_correction(const std::vector<data::keyframe *> &neighbors) const;

        //! Compute Sim3s (world to covisibility) which are corrected using the estimated Sim3 of the current keyframe
        module::keyframe_Sim3_pairs_t get_Sim3s_after_loop_correction(const Mat44_t &cam_pose_wc_before_correction,
        ...
        extract_new_connections(const std::vector<data::keyframe *> &covisibilities) const;
...
#endif //VSLAM_GLOBAL_OPTIMIZATION_MODULE_H
