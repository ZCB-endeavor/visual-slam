...
namespace pangolin_viewer {
    viewer::viewer(const YAML::Node &yaml_node, vslam::system *system,
    ...
    void viewer::draw_keyframes() {
        ...
        std::vector<vslam::data::keyframe *> keyfrms;
        ...
        if (*menu_show_graph_) {
            ...
            const auto draw_edge = [](const vslam::Vec3_t &cam_center_1, const vslam::Vec3_t &cam_center_2) {
            ...
            for (const auto keyfrm : keyfrms) {
                ...
                const vslam::Vec3_t cam_center_1 = keyfrm->get_cam_center();
                ...
                if (!covisibilities.empty()) {
                    for (const auto covisibility : covisibilities) {
                        ...
                        const vslam::Vec3_t cam_center_2 = covisibility->get_cam_center();
                ...
                if (spanning_parent) {
                    const vslam::Vec3_t cam_center_2 = spanning_parent->get_cam_center();
                    draw_edge(cam_center_1, cam_center_2);
                }
                ...
                for (const auto loop_edge : loop_edges) {
                    ...
                    const vslam::Vec3_t cam_center_2 = loop_edge->get_cam_center();
                    draw_edge(cam_center_1, cam_center_2);
                }
            }
    ...
    void viewer::draw_camera(const vslam::Mat44_t &cam_pose_wc, const float width) const {
        glPushMatrix();
