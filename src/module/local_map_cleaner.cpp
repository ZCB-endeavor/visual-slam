...
#include "vslam/module/local_map_cleaner.h"
...
namespace vslam {
    namespace module {
        ...
        unsigned int
        local_map_cleaner::remove_redundant_landmarks(const unsigned int cur_keyfrm_id, const bool depth_is_avaliable) {
        ...
        void local_map_cleaner::count_redundant_observations(data::keyframe *keyfrm, unsigned int &num_valid_obs,
