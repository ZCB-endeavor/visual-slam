...
namespace vslam {
    namespace data {
        ...
        keyframe::keyframe(const unsigned int id, const unsigned int src_frm_id, const double timestamp,
                ...
                // ORB scale pyramid
                num_scale_levels_(num_scale_levels), scale_factor_(scale_factor),
        ...
        keyframe::get_keypoints_in_cell(const float ref_x, const float ref_y, const float margin) const {
