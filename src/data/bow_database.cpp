...
namespace vslam {
    namespace data {
        ...
        template<typename T>
        bool bow_database::set_candidates_sharing_words(const T *const qry_shot,
                                                        const std::set<keyframe *> &keyfrms_to_reject) {
            init_candidates_.clear();
            num_common_words_.clear();
        ...
        bool
        bow_database::align_scores_and_keyframes(const unsigned int min_num_common_words_thr, const float min_score) {
            score_keyfrm_pairs_.clear();
        ...
        float bow_database::align_total_scores_and_keyframes(const unsigned int min_num_common_words_thr,
