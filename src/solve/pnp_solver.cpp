...
#include "vslam/util/fancy_index.h"
...
namespace vslam {
    namespace solve {
        ...
        unsigned int
        pnp_solver::check_inliers(const Mat33_t &rot_cw, const Vec3_t &trans_cw, std::vector<bool> &is_inlier) {
        ...
        eigen_alloc_vector<Vec4_t>
        pnp_solver::compute_barycentric_coordinates(const eigen_alloc_vector<Vec3_t> &control_points,
                                                    const eigen_alloc_vector<Vec3_t> &pos_ws) {
            const unsigned int num_correspondences = pos_ws.size();
        ...
        pnp_solver::compute_pcs(const eigen_alloc_vector<Vec4_t> &alphas, const eigen_alloc_vector<Vec3_t> &ccs,
        ...
        double pnp_solver::reprojection_error(const eigen_alloc_vector<Vec3_t> &pws,
        ...
        void pnp_solver::estimate_R_and_t(const eigen_alloc_vector<Vec3_t> &pws, const eigen_alloc_vector<Vec3_t> &pcs,
