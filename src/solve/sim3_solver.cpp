...
namespace vslam {
    namespace solve {
        ...
        void sim3_solver::compute_Sim3(const Mat33_t &pts_1, const Mat33_t &pts_2,
            ...
            eigenvector << max_eigenvector(0, 0).real(), max_eigenvector(1, 0).real(), max_eigenvector(2,
                                                                                                       0).real(), max_eigenvector(
                    3, 0).real();
        ...
        unsigned int sim3_solver::count_inliers(const Mat33_t &rot_12, const Vec3_t &trans_12, const float scale_12,
            ...
            reproject_to_other_image(common_pts_in_keyfrm_1_, reprojected_1_in_cam_2, rot_21, trans_21, scale_21,
                                     keyfrm_2_);
            ...
            reproject_to_other_image(common_pts_in_keyfrm_2_, reprojected_2_in_cam_1, rot_12, trans_12, scale_12,
                                     keyfrm_1_);
        ...
        void sim3_solver::reproject_to_other_image(
            ...
            for (const auto &lm_coord_in_cam_1 : lm_coords_in_cam_1) {
                ...
                float x_right;
                keyfrm->camera_->reproject_to_image(scale_21 * rot_21, trans_21, lm_coord_in_cam_1, reproj_in_cam_2,
                                                    x_right);
        ...
        void sim3_solver::reproject_to_same_image(
            ...
            for (const auto &lm_coord_in_cam : lm_coords_in_cam) {
                Vec2_t reproj;
                float x_right;
                keyfrm->camera_->reproject_to_image(Mat33_t::Identity(), Vec3_t::Zero(), lm_coord_in_cam, reproj,
                                                    x_right);
