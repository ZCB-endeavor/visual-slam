...
#include "vslam/solve/homography_solver.h"
...
namespace vslam {
    namespace solve {
        ...
        void homography_solver::find_via_ransac(const unsigned int max_num_iter, const bool recompute) {
            ...
            const Mat33_t normalized_H_21 = solve::homography_solver::compute_H_21(inlier_normalized_keypts_1,
        ...
        Mat33_t homography_solver::compute_H_21(const std::vector<cv::Point2f> &keypts_1,
