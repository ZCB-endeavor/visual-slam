    ...
    namespace feature {
        ...
        orb_params::orb_params(const YAML::Node &yaml_node)
                : orb_params(yaml_node["max_num_keypoints"].as<unsigned int>(2000),
                             ...
                             yaml_node["mask_rectangles"].as<std::vector<std::vector<float>>>(
                                     std::vector<std::vector<float>>())) {}

        std::vector<float>
        orb_params::calc_scale_factors(const unsigned int num_scale_levels, const float scale_factor) {
        ...
        std::vector<float>
        orb_params::calc_inv_scale_factors(const unsigned int num_scale_levels, const float scale_factor) {
        ...
        std::vector<float>
        orb_params::calc_level_sigma_sq(const unsigned int num_scale_levels, const float scale_factor) {
        ...
        std::vector<float>
        orb_params::calc_inv_level_sigma_sq(const unsigned int num_scale_levels, const float scale_factor) {
            float scale_factor_at_level = 1.0;
