...
#include "vslam/optimize/internal/sim3/graph_opt_edge.h"
    ...
    namespace optimize {
        ...
        void graph_optimizer::optimize(data::keyframe *loop_keyfrm, data::keyframe *curr_keyfrm,
            ...
            const auto insert_edge =
                    [&optimizer, &vertices, &inserted_edge_pairs](unsigned int id1, unsigned int id2,
            ...
            for (auto keyfrm : all_keyfrms) {
                ...
                const g2o::Sim3 Sim3_w1 = ((iter1 != non_corrected_Sim3s.end()) ? iter1->second : Sim3s_cw.at(
                        id1)).inverse();
