...
#include "vslam/optimize/internal/landmark_vertex_container.h"
#include "vslam/optimize/internal/se3/shot_vertex_container.h"
#include "vslam/optimize/internal/se3/reproj_edge_wrapper.h"
...
namespace vslam {
    namespace optimize {
        global_bundle_adjuster::global_bundle_adjuster(data::map_database *map_db, const unsigned int num_iter,
                                                       const bool use_huber_kernel)
                : map_db_(map_db), num_iter_(num_iter), use_huber_kernel_(use_huber_kernel) {}

        void global_bundle_adjuster::optimize(const unsigned int lead_keyfrm_id_in_global_BA,
