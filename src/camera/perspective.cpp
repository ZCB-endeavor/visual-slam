...
namespace vslam {
    namespace camera {
        perspective::perspective(const std::string &name, const setup_type_t &setup_type,
                ...
                : base(name, setup_type, model_type_t::Perspective, color_order, cols, rows, fps, focal_x_baseline,
                       focal_x_baseline / fx),
        ...
        void perspective::undistort_keypoints(const std::vector<cv::KeyPoint> &dist_keypts,
        ...
        void perspective::convert_bearings_to_keypoints(const eigen_alloc_vector<Vec3_t> &bearings,
                                                        std::vector<cv::KeyPoint> &undist_keypts) const {
        ...
        bool perspective::reproject_to_image(const Mat33_t &rot_cw, const Vec3_t &trans_cw, const Vec3_t &pos_w,
                                             Vec2_t &reproj, float &x_right) const {
        ...
        bool perspective::reproject_to_bearing(const Mat33_t &rot_cw, const Vec3_t &trans_cw, const Vec3_t &pos_w,
                                               Vec3_t &reproj) const {
            // convert to camera-coordinates
